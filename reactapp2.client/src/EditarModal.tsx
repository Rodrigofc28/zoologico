    ...
    return (
        <div className="modal">
            <div className="modal-content">
                ...
                <span>Espécie</span>
                <input type="text" placeholder="Espécie" value={form.especie} onChange={e => setForm({ ...form, especie: e.target.value })} />
                <span>Habitat</span>
                <input type="text" placeholder="Habitat" value={form.habitat} onChange={e => setForm({ ...form, habitat: e.target.value })} />
                <span>País de Origem</span>
                <input type="text" placeholder="País de Origem" value={form.paisOrigem} onChange={e => setForm({ ...form, paisOrigem: e.target.value })} />
